...
document.addEventListener("DOMContentLoaded", function () {
    var form = document.querySelector("#credit-score-form");
    var resultDiv = document.getElementById("result");
    form.addEventListener("submit", function (event) { return __awaiter(_this, void 0, void 0, function () {
        var salary, debt, savings, modelChoice, response, result, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    result = _a.sent();
                    // Display the result
                    resultDiv.innerHTML = "Your estimated credit score is: ".concat(result);
